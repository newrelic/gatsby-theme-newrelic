...
| `externalIcon` | bool | no      |         | If the `to` is external to the current site, and you want the element to include an icon showing this leads toan external site, set this to `true` |
